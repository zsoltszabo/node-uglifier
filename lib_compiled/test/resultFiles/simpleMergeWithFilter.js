...
}).call(this,cachedModules[4102],cachedModules[4102].exports);
cachedModules[6131]={exports:{}};
(function(module,exports) {// Generated by CoffeeScript 1.9.0
(function() {
  var SomeClass2;
...
}).call(this,cachedModules[6131],cachedModules[6131].exports);// Generated by CoffeeScript 1.9.0
(function() {
  var C, SomeClass, SomeClass2, crypto, cryptoLoc, deepModule, dynamicFileName, dynamicImport, emptyString, fun, message, r, rootDependency, shasum, sugar, _;

  fun = cachedModules[7624].exports;
  ...
  rootDependency = cachedModules[1326].exports;

  crypto = require('crypto');

  deepModule = cachedModules[6804].exports;

  SomeClass = new (cachedModules[4102].exports)("test1");

  SomeClass2 = cachedModules[6131].exports;
