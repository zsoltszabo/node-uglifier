  ...
  NodeUglifier = (function() {
    ...
    NodeUglifier.prototype.merge = function() {
      ...
      recursiveSourceGrabber = function(filePath) {
        var ast, basename, filteredOutFilesObj, isSourceObjDepFiltered, isSourceObjFiltered, otherSerial, pathSaltedHash, replacement, requireStatement, requireStatements, source, sourceObj, sourceObjDep, _i, _len;
        ...
        for (_i = 0, _len = requireStatements.length; _i < _len; _i++) {
          ...
          if (isSourceObjFiltered && packageUtils.getIfNonNativeNotFilteredNonNpm(requireStatement.path)) {
